...
> **Scope note:** ISO 42001 is primarily an _organisational_ management system standard. Many of its requirements (leadership commitment, internal audits, management reviews) cannot be verified from code alone. This reference focuses on clauses and annex controls that produce code or documentation artifacts — things a codebase audit can actually find evidence of or flag as missing.
